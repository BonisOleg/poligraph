...
def equipment(request):
    ...
    context = {
        'main_device': {
            ...
            'model': 'Український виробник',
            'description': 'Найсучасніший український поліграф від офіційних дилерів в Україні',
            'features': [
                'Надійні конектори та якісні давачі',
                'Екологічно чисті матеріали',
                '7 реєстраційних каналів',
                'Подовжена гарантія до 3 років'
            ],
            'specifications': {
                'Точність': '98.5%',
                'Кількість каналів': '7',
                'Реєстраційні канали': 'ШГР, ФПГ, Дихання (2), Тиск',
                'Гарантія': 'До 3 років'
            }
        },
        'additional_equipment': [
            {
                'name': 'Давач ШГР',
                'description': 'Канал електро-шкірної активності (шкірно-гальванічна реакція)'
            },
            {
                'name': 'Давач ФПГ',
                'description': 'Канал периферійної серцево-судинної активності (фотоплетизмограма)'
            },
            {
                'name': 'Давач дихання',
                'description': '2 канали: грудної і діафрагмальної респіраторної активності'
            },
            {
                'name': 'Давач тиску',
                'description': 'Канал центральної серцево-судинної активності'
            }
        ]
    }
